...
> **Version:** Slim — Auth, Analytics & Notifications excluded
...
| US-00c-T02 | Implement invite code/link generation endpoint | BE | P1 | 3 | — |
| US-00c-T03 | Implement join-household endpoint: add user to household | BE | P1 | 2 | US-00c-T02 |
...
| US-00c-T06 | Write integration tests: join flow for new and existing users | QA | P1 | 2 | US-00c-T05 |
...
| US-02-T02 | Implement add item endpoint: persist item with name, quantity, unit, household tag | BE | P1 | 3 | US-01-T04 |
...
| US-02-T05 | Bind real-time listener: render new items immediately on receipt | FE | P0 | 3 | US-02-T03 |
...
| US-04-T03 | Implement soft-delete with 5-second undo window; permanent delete on expiry | BE | P1 | 3 | US-04-T02 |
| US-04-T04 | Implement undo endpoint: restore item within window | BE | P1 | 2 | US-04-T03 |
| US-04-T05 | Broadcast edit/delete/undo events to all members in real time | BE | P1 | 2 | US-04-T02, US-02-T03 |
| US-04-T06 | Build inline edit UI and ownership-gated controls | FE | P1 | 3 | US-04-T01, US-04-T02 |
| US-04-T07 | Build undo toast: 5-second display, tap-to-undo, auto-dismiss | FE | P1 | 2 | US-04-T03, US-04-T04 |
| US-04-T08 | Write integration tests: edit, delete, undo in/out of window, cross-household permission block | QA | P1 | 3 | US-04-T07 |

**Story Subtotal: 20 SP**
...
| US-07-T02 | Implement Shopper Mode session endpoint: create session, enforce one-active-per-group | BE | P0 | 3 | US-01-T04 |
| US-07-T03 | Implement concurrent conflict response: return blocker with active shopper's name | BE | P0 | 2 | US-07-T02 |
| US-07-T04 | Build Shopper Mode UI: optimised layout, activate button | FE | P0 | 5 | US-07-T01, US-07-T02 |
| US-07-T05 | Build conflict screen: blocking message with active shopper's name | FE | P0 | 2 | US-07-T03 |
...
| US-08-T04 | Implement offline queue: capture check-off actions locally, sync on reconnect | BE | P0 | 5 | US-08-T02 |
| US-08-T05 | Build check-off UI: single tap toggle, purchased section, remaining count | FE | P0 | 3 | US-08-T01, US-08-T02 |
| US-08-T06 | Build offline banner and local action queue: "You're offline — changes will sync when reconnected" | FE | P0 | 5 | US-08-T04 |
...
| US-09-T02 | Extend add item endpoint to accept items from active Shopper Mode; attribute to Shopper's household | BE | P1 | 2 | US-02-T02, US-07-T02 |
...
| US-10-T02 | Ensure new items added during active session are flagged as "newly added" in the real-time payload | BE | P1 | 1 | US-02-T02, US-07-T02 |
| US-10-T03 | Build new item visual flag and top-of-list positioning in Shopper Mode | FE | P1 | 2 | US-10-T01, US-10-T02 |
...
| US-11-T02 | Implement complete trip endpoint: close session, archive purchased items, retain unpurchased as pending | BE | P0 | 3 | US-07-T02, US-08-T02 |
...
| US-12-T03 | Implement retention job: archive/purge summaries after 30 days | BE | P1 | 3 | US-12-T02 |
...
| Task ID | Description | Type | Priority | SP | Dependencies |
|---|---|---|---|---|---|
| NFR-03-T01 | Add `completed_at` and `expires_at` (completed_at + 30 days) to trip summary DB schema | DB | P1 | 2 | US-11-T02 |
| NFR-03-T02 | Implement scheduled purge job for summaries older than 30 days | BE | P1 | 3 | NFR-03-T01 |
...
|---|---|---|---|
| **Sprint 1** | US-00c, US-00d, US-01 | Household & group setup | 51 |
| **Sprint 2** | US-02, US-03, US-04, US-05 | Core list functionality | 61 |
| **Sprint 3** | US-06, US-07, US-08 | Purchased view, Shopper Mode, check-off + offline | 50 |
| **Sprint 4** | US-09, US-10, US-11, US-12, NFR-03 | Trip actions, summary, retention | 46 |
...
| Shared List | US-01 – US-06 | 92 |
| Shopper Mode | US-07 – US-12 | 82 |
| NFR | NFR-03 | 7 |
| **Grand Total** | **14 stories · 1 NFR** | **208 SP** |
...
*FamilyCart · MVP Task Breakdown (Pilot Slim) · v1.1 · February 22, 2026*
